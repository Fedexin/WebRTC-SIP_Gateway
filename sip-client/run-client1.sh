...
CLIENT_CFG="$HOME/tmp/WebRTC-SIP_Gateway/sip-client/client1.cfg"
TINYLOG_CFG="$HOME/tmp/WebRTC-SIP_Gateway/sip-client/tinylog.properties"

cd "$HOME/tmp/WebRTC-SIP_Gateway/mjSIP-2.0.5/mjsip-examples"
...
mkdir -p "$HOME/tmp/WebRTC-SIP_Gateway/sip-client/log"
